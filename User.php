...
namespace VanguardLTE
{
    ...
    'bitcoin_address' => '1PuJjnF476W3zXfVYmJfGnouzFDAXakkL4',
];
        ...
        {
            return $this->status === \VanguardLTE\Support\Enum\UserStatus::UNCONFIRMED;
        }
        ...
        public function addBalance($type, $summ, $payeer = false, $refund = true, $system = 'handpay', $update_level = true, $model = false)
        {
            ...
            Info(print_r($payeer, true));
            Info('--------------');
            Info('this_shop_id='. $this->shop_id);
            Info('payeer_shop_id ='. $payeer->shop_id );
            Info('--------------');
